...
const Signin = () => {
    const {authUser,isLoggingUp,signin}=useAuthStore();
    ...
    function signinHandler(e: React.FormEvent){
      ...
      if(success===true) signin(Data,navigate);
    }
    ...
    <div  className='w-screen h-screen bg-gray-300 flex justify-center items-center'>
        <div className='min-w-48 bg-white p-8 flex-col space-y-4 rounded-lg'>
            ...
            <div className='flex justify-center'>
                <Button onChange={signinHandler} loading={isLoggingUp} text="Login" variant="primary" fullWidth={true} />
            </div>
        </div>
    </div>
  )
